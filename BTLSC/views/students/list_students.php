...
$sql = "SELECT id, full_name, dob, email, phone FROM students";
        ...
        <div class="main-content">
            <div class="header-row">
                ...
                <div class="btn-add-wrapper">
                    <a href="add_students.php" class="btn btn-add">+ Thêm học viên</a>
                </div>
            </div>
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href='../../handle/student_process.php?delete=".$row['id']."' class='btn btn-delete' onclick='return confirm(\"Xóa học viên này?\")'>Xóa</a>
                                        </td>
                                      </tr>";
                            }
                        } else {
                            echo "<tr><td colspan='6' style='text-align:center; padding:15px; font-style:italic; color:#555;'>Chưa có học viên nào</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
